...
<div class="container-fluid px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
	...
	@endif
        <div class="row d-flex ">
            <div class="col-lg-6 mt-5">
                <div class="card1 pb-5">
                    <div class="row  justify-content-center mt-5 mb-5 border-line"><img src="{{ asset('main1.jpg') }}"class="image" />  </div>
                </div>
            </div>
							...
							<div class="col-lg-12 mt-5">
								<form id="login-form" action="{{ url('login/update') }}" method="post" role="form" style="display: block;">
									<div class="form-group">
										<input type="text"  name="email"   placeholder="Enter a valid email address OR Phone Number" id="email" tabindex="1" class="form-control"  required>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<div class="row">
                                            ...
                                            <button type="submit" id="button" class="btn btn-primary text-center col-md-12" style="background-color: #047770"><h6>Login </h6> </button>
								...
								<form id="register-form" action="{{ url('signup') }}" method="post" role="form" style="display: none;">
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 offset-sm-3">
                                                <button type="submit" class="btn btn-success text-center col-md-12" style="background-color: #047770"><h6>SignUp </h6></button> </div>
											</div>
										</div>
									</div>
								</form>
        ...
        <div class=" mt-5 ">
            <div class="row px-3"> <small class="ml-4 ml-sm-5 mt-2 "><h5>Developer:- Devanshi Harsora </h5></small>
            </div>
        </div>
    </div>
</div>
